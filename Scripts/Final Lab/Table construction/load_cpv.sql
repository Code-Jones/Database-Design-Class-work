...
INSERT INTO cp_dvd VALUES (100, 'BEST YEARS', 1, 'B');
INSERT INTO cp_dvd VALUES (101, 'BEST YEARS', 1, 'B');
INSERT INTO cp_dvd VALUES (102, 'SILENCE LAMBS', 2, 'A');
INSERT INTO cp_dvd VALUES (103, 'SILENCE LAMBS', 2, 'A');
INSERT INTO cp_dvd VALUES (104, 'SILENCE LAMBS', 1, 'A');
INSERT INTO cp_dvd VALUES (105, 'SILENCE LAMBS', 2, 'A');
INSERT INTO cp_dvd VALUES (106, 'HORSE FEATHERS', 2, 'C');
INSERT INTO cp_dvd VALUES (107, 'ANNE OF 1000', 1, 'A');
INSERT INTO cp_dvd VALUES (108, 'MACON COUNTY', 1, 'B');
INSERT INTO cp_dvd VALUES (109, 'ANNE OF 1000', 1, 'A');
INSERT INTO cp_dvd VALUES (110, 'HORSE FEATHERS', 1, 'C');
...
INSERT INTO cp_rental VALUES (
1005, 102, SYSDATE + 1, SYSDATE + 2 , NULL);
INSERT INTO cp_rental VALUES (
1002, 102, SYSDATE - 3, SYSDATE - 2, SYSDATE);

COMMIT;
rem cp_rents is a list of DVDs that have been rented and need to be
rem processed, e.g. their related records in cp_rental need to be updated
